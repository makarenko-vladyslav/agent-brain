...
**Доводь до живого результату, не до файлу.** Згенерований HTML — не результат;
результат — адреса, яку можна відкрити. Налаштування в панелях (Vercel, DNS,
рекламний кабінет) роби сам через браузер, а не диктуй кроки власнику.
Повністю: `brain/rules/finish-on-live-result.md`.
